      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-6 offset-3">
            <form id="url-submit-form" onSubmit={this.submitUrl}
              ref={form => {
                this.urlForm = form
              }}>
              <div className="input-group">
                <input type="text" id="url-submit-input" name="url-submit-input" className="form-control" placeholder="Your URL Goes Here"
                  onChange={this.updateUrlInput} value={this.props.urlInputValue}/>
                <span className="input-group-btn">
                  <button id="url-submit-btn" className="btn btn-default" type="submit">Engage!</button>
                </span>
              </div>
            </form>
          </div>
